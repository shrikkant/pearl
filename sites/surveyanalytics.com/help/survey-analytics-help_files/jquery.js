...
jQuery(function($) {
	...
	function processModal(settings) {
		...
		currentSettings.type = fileType();
                //QP Edit
                if ('iframe' == currentSettings.type) {
                    if (!$.fn.nyroModal.settings.width) {
                        $.fn.nyroModal.settings.width = 820;
                        currentSettings.width=$.fn.nyroModal.settings.width;
                    }
                    if (!$.fn.nyroModal.settings.height) {
                        $.fn.nyroModal.settings.height = 700;
                        currentSettings.height=$.fn.nyroModal.settings.height;
                    }
                }
